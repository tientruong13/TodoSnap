...
class CreateDailyOptions extends StatefulWidget {
  const CreateDailyOptions({
    Key? key,
    required this.task,
  ...
  @override
  State<CreateDailyOptions> createState() => _CreateDailyOptionsState();
}

class _CreateDailyOptionsState extends State<CreateDailyOptions> {
