...
class CreateWeeklyOptions extends StatefulWidget {
  const CreateWeeklyOptions({
    Key? key,
    required this.task,
  ...
  @override
  State<CreateWeeklyOptions> createState() => _CreateWeeklyOptionsState();
}

class _CreateWeeklyOptionsState extends State<CreateWeeklyOptions> {
